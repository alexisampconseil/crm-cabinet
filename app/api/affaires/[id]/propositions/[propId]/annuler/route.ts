...
import { requireConseiller, annulerProposition, toHttp } from '@/lib/affaires'
...
// POST /api/affaires/:id/propositions/:propId/annuler
export async function POST(
  ...
  try {
    ...
    const result = await annulerProposition(supabase, {
