...
export default function GouvernanceFiltres() {
  ...
  const update = (key: string, value: string) => {
    ...
    router.push(`/gouvernance?${params.toString()}`)
  }
  ...
  const hasFilters = Object.values(v).some(Boolean)
  ...
  return (
    <div style={s.bar}>
      ...
      {hasFilters && (
        <button
          style={s.reset}
          onClick={() => router.push('/gouvernance')}
        >
          Réinitialiser
        </button>
      )}
